...
class CallPlugin {
  public renderFirstSlider(id: string, panel: (number | boolean | string)[]) {
  ...
  public renderSecondSlider(id: string, panel: (number | boolean | string)[]) {
    // render slider with info from panel
    // delete duplicates of slider when panel is used
    const elem = <HTMLDivElement>document.getElementById(id);
    if (elem.firstElementChild) {
  ...
  public renderThirdSlider(id: string, panel: (number | boolean | string)[]) {
    // render slider with info from panel
    // delete duplicates of slider when panel is used
    const elem = <HTMLDivElement>document.getElementById(id);
    if (elem.firstElementChild) {
  ...
  public renderFourthSlider(id: string, panel: (number | boolean | string)[]) {
    // render slider with info from panel
    // delete duplicates of slider when panel is used
    const elem = <HTMLDivElement>document.getElementById(id);
    if (elem.firstElementChild) {
